...
#Strategy: The first two values in nums will always be in the final array. So,
#start with the third element and k equal to 3. Check if it has the same value 
#as nums[k-1] and nums[k-2]. If not, move it to the kth index and increment k 
